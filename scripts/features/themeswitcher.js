...
Object.assign(btn.style, { background: t.name === 'Reset' ? '#2a1a1a' : '#1e1e2e', color: t.accent || '#ffffff', border: '1px solid ' + (t.accent || '#555'), borderRadius: '6px', padding: '6px 10px', cursor: 'pointer', fontSize: '13px', textAlign: 'left' });
